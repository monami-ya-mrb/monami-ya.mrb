...
{
  static const struct heap_page heap_page_zero = { 0 };
  struct heap_page *page = (struct heap_page *)mrb_malloc(mrb, sizeof(mrb_heap_page) + MRB_HEAP_PAGE_SIZE * sizeoof(RVALUE));
  RVALUE *p, *e;
