...
#define MAXARG_sBx       (MAXARG_Bx / 2)         /* `sBx' is signed */
...
#define GETARG_A(i)              ((int)( (mrb_code)(i)               >> 24))
#define GETARG_B(i)              ((int)(((mrb_code)(i) & 0x00ff8000) >> 15))
#define GETARG_C(i)              ((int)(((mrb_code)(i) & 0x00007f00) >>  8))
#define GETARG_Bx(i)             ((int)(uint16_t)(((mrb_code)(i)) >>  8))
#define GETARG_sBx(i)            ((int)(GETARG_Bx(i)-MAXARG_sBx))
#define GETARG_Ax(i)             ((int32_t)((mrb_code)(i) >> 8))
#define GETARG_UNPACK_b(i,n1,n2) ((int)((((mrb_code)(i)) >> (8+(n2))) & (((1<<(n1))-1))))
#define GETARG_UNPACK_c(i,n1,n2) ((int)((((mrb_code)(i)) >> 8) & (((1<<(n2))-1))))
#define GETARG_b(i)              GETARG_UNPACK_b(i,14,2)
#define GETARG_c(i)              GETARG_UNPACK_c(i,14,2)

#define MKOPCODE(op)          ((mrb_code)(op) & 0xffU)
#define MKARG_A(c)            ((mrb_code)((c) & 0xffU) << 24)
#define MKARG_B(c)            ((mrb_code)((c) & 0x1ffU) << 15)
#define MKARG_C(c)            ((mrb_code)((c) & 0x7fU) <<  8)
#define MKARG_Bx(v)           ((mrb_code)((v) & 0xffffU) << 8)
#define MKARG_sBx(v)          MKARG_Bx((v)+MAXARG_sBx)
#define MKARG_Ax(v)           ((mrb_code)((v) & 0xffffff) << 8)
#define MKARG_PACK(b,n1,c,n2) ((((mrb_code)(b) & ((1<<(n1))-1)) << (8+(n2)))|(((mrb_code)(c) & ((1<<(n2))-1)) << 8))
